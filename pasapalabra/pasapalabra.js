...
let questionList = [
    ...
    { letter: "h", answer: ["hacker", "hardware", "harmonyos"], status: 0, question: ["CON LA H: Pirata informático", "CON LA H: Componentes físicos de un PC.", "CON LA H: Nombre del sistema operativo de Huawei"] },
    { letter: "i", answer: ["internet", "intel", "ip"], status: 0, question: ["CON LA I: Red informática de nivel mundial que utiliza la línea telefónica para transmitir la información", "CON LA I: Primera empresa de procesadores.", "CON LA I: Direccion única e irrepetible que se asigna a un dispositivo que trata de comunicarse con otro en Internet"] },
    { letter: "j", answer: ["jpg", "joke", "javascript"], status: 0, question: ["CON LA J: Formato de imagen más popular con gran grado de compresión.", "CON LA J: No es un virus, sino bromas de mal gusto que tienen por objeto hacer pensar a los usuarios que han sido afectados por un virus.", "CON LA J: Lenguaje de programación interpretado, dialecto del estándar ECMAScript. Se define como orientado a objetos, ​ basado en prototipos, imperativo, débilmente tipado y dinámico."] },
    { letter: "k", answer: ["kindle", "keylogger", "key"], status: 0, question: ["CON LA K: Tableta diseñada por Amazon.com como la versión multimedia del lector de libros electrónicos", "CON LA K: Programa que recoge y guarda una lista de todas las teclas pulsadas por un usuario. Dicho programa puede hacer pública la lista, permitiendo que terceras personas conozcan estos datos -lo que ha escrito el usuario afectado", "CON LA K: Tecla, en su uso más general, o bien, por extensión, el teclado."] },
    { letter: "l", answer: ["link", "linux", "lcd"], status: 0, question: ["CON LA L: Elemento de un documento electrónico que permite acceder automáticamente a otro documento o a otra parte del mismo.", "CON LA L: Sistema operativo gratuito para PC derivado de Unix", "CON LA L: Monitor de Cristal Líquido."] },
    { letter: "m", answer: ["microsoft", "malware", "meme"], status: 0, question: ["CON LA M: Fundada en 1975 por Bill Gates, entre otros.", "CON LA M: Cualquier programa, documento o mensaje, susceptible de causar perjuicios a los usuarios de sistemas informáticos. MALicious softWARE.", "CON LA M: Imagen, video o texto, por lo general distorsionado con fines caricaturescos que se difunde principalmente a través de Internet"] },
    { letter: "n", answer: ["navegador", "netiqueta", "nuke"], status: 0, question: ["CON LA N: Software informático que permite acceder a internet", "CON LA N: Norma o regla que tengo que cumplir para no generar conflictos cuando me comunico en la red", "CON LA N: Caída o pérdida de la conexión de red, provocada de forma intencionada por alguna persona."] },
    { letter: "o", answer: ["open source", "offline", "ocr"], status: 0, question: ["CON LA O: Expresión de la lengua inglesa que pertenece al ámbito de la informática. Aunque puede traducirse como fuente abierta o código abierto", "CON LA O: Modo en el que trabajo cuando no tengo Internet", "CON LA O: Reconocimiento óptico de caracteres."] },
    { letter: "p", answer: ["perfil", "programar", "podcast"], status: 0, question: ["CON LA P: He de crearme uno para acceder por primera vez a mi red social favorita", "CON LA P: Dar instrucciones a un dispositivo digital para que realice una tarea en un momento determinado", "CON LA P: Emisión de radio o de televisión que un usuario puede descargar de internet mediante una suscripción previa y escucharla tanto en una computadora como en un reproductor portátil."] },
    { letter: "q", answer: ["qr", "quicktime", "quick access"], status: 0, question: ["CON LA Q: Código de barras de 2D compuesto por módulos negros en forma de cuadrado con fondo blanco", "CON LA Q: Formato de video creado por Apple.", "CON LA Q: Acceso rápido en ingles."] },
    { letter: "r", answer: ["recomendar", "ram", "robo de identidad"], status: 0, question: ["CON LA R: En LinkedIn, dar un like", "CON LA R: Memoria de acceso aleatorio.", "CON LA R: Obtención de información confidencial del usuario, como contraseñas de acceso a diferentes servicios, con el fin de que personas no autorizadas puedan utilizarla para suplantar al usuario afectado."] },
    { letter: "s", answer: ["serie", "selfie", "servidor"], status: 0, question: ["CON LA S: Cuando los componentes de un circuito están dispuestos en una línea, uno tras otro, se dice que hay una conexión en...", "CON LA S: Autofoto", "CON LA S: Ordenador conectado a la red que presta asistencia a otros usuarios"] },
    { letter: "t", answer: ["tutor", "teclado", "troyano"], status: 0, question: ["CON LA T: Persona que resuelve mis dudas sobre el curso online que estoy haciendo", "CON LA T: Dispositivo principal de entrada en PC.", "CON LA T: Programa que llega al ordenador de manera encubierta, aparentando ser inofensivo, se instala y realiza determinadas acciones que afectan a la confidencialidad del usuario afectado."] },
    { letter: "u", answer: ["ubicacion", "ubuntu", "url"], status: 0, question: ["CON LA U: La comparto cuando quiero decir dónde estoy", "CON LA U: Distribución de Linux más famosa basada en Debian.", "CON LA U: Dirección a través de la cual se accede a las páginas Web en Internet"] },
    { letter: "v", answer: ["viral", "visical", "virus"], status: 0, question: ["CON LA V: Acepción referida a un mensaje o contenido que se difunde con gran rápidez a través de las redes sociales", "CON LA V: Primera hoja de cálculo", "CON LA V: Programas que se pueden introducir en los ordenadores y sistemas informáticos de formas muy diversas, produciendo efectos molestos, nocivos e incluso destructivos e irreparables."] },
